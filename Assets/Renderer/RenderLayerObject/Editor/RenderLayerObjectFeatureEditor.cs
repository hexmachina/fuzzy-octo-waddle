...
[CustomPropertyDrawer(typeof(RenderLayerObjectFeature.RenderObjectsSettings), true)]
public class RenderLayerObjectFeatureEditor : PropertyDrawer
{
	...
	private void Init(SerializedProperty property)
	{
		...
		m_LayerMask = m_FilterSettings.FindPropertyRelative("RenderLayerMask");
